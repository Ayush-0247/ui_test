...
export default function Performance() {
  return (
    <div className="relative flex min-h-screen bg-[#F8F9FC] font-sans text-xs text-gray-800">
              ...
              <div className="lg:col-span-7 bg-white rounded-2xl border border-gray-200 p-4 flex flex-col justify-between shadow-xs">
                <div>
                  ...
                  <div className="flex items-center gap-4 text-[10px] text-gray-500 mb-3 flex-wrap">
                    ...
                    <span className="flex items-center gap-1">
                      <span className="w-2 h-2 rounded-full bg-sky-500" /> Avg
                      Likes
                    </span>
                    <span className="flex items-center gap-1">
                    ...
                    <div className="flex-1 flex flex-col gap-2 text-[10px] min-w-[180px]">
                      ...
                      <div className="flex items-start gap-1.5">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 leading-tight">
                            Reels drive highest engagement, room to increase
                            video mix
                          </p>
                        </div>
                      </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2.5">
                ...
                <div className="p-2.5 rounded-xl border border-gray-100 bg-gray-50/50 flex items-start gap-2.5">
                  ...
                  <p className="text-[10px] text-gray-600 leading-tight">
                    ...
                    <span className="font-bold text-gray-800">+0.29pp</span>{" "}
                ...
                <div className="p-2.5 rounded-xl border border-gray-100 bg-gray-50/50 flex items-start gap-2.5">
                  ...
                  <p className="text-[10px] text-gray-600 leading-tight">
                    ...
                    <span className="font-bold text-gray-800">13%</span> of
                    similar creators.
                  </p>
                </div>
              </div>
